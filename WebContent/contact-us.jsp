      ...
      <div class="header-bar__right large--display-table-cell">
        <div class="header-bar__module">
          ...
          <ul class="header-bar__module header-bar__module--list">
              ...
              <li>
                <a href="LoginServlet" id="customer_login_link">Log in</a>
              </li>
...
<div class="rte">
	...
	<div id="gmap" class="contact-map">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14032.943798834374!2d77.05003690000001!3d28.442302900000012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1866a021dca3%3A0x48747b8bb3b2100f!2sSector+39%2C+Gurgaon%2C+Haryana!5e0!3m2!1sen!2sin!4v1436869099929" width="1200" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
	</div>
<div class="rte">
  
</div>

<form accept-charset="UTF-8" action="MessageServlet" class="contact-form" method="post">
<input name="form_type" value="contact" type="hidden">

  <label for="ContactFormName" class="label--hidden">Name</label>
  <input id="ContactFormName" name="name" placeholder="Name" autocapitalize="words" type="text">

  <label for="ContactFormEmail" class="label--hidden">Email</label>
  <input id="ContactFormEmail" name="email" placeholder="Email" autocorrect="off" autocapitalize="off" type="email">

  
  <label for="ContactFormPhone" class="label--hidden">Subject</label>
  <input id="ContactFormPhone" name="subject" placeholder="Subject (Optional)"  type="text">

  <label for="ContactFormMessage" class="label--hidden">Message</label>
  <textarea rows="10" id="ContactFormMessage" name="mes" placeholder="Message"></textarea>

  <input class="btn right" value="Send" type="submit">
