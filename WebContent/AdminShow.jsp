...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="AdminLoginServlet"> <img alt="Charisma Logo" src="smartlogo.png" /> </a>
	...
	<!-- topbar ends -->
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> <%=head %></h2>
						<div class="box-icon">
		...
		<footer>
			<p class="pull-left">&copy; <a href="AdminLoginServlet" target="_blank">Smart City | Jalandhar</a> 2015</p>
			<p class="pull-right">Designed by: <a href="http://www.facebook.com">Vikrant Choudhary</a></p>
		</footer>
